    ...
    <div class="wordsc helement" id="words">
        <div class="row">
            ...
            <div class="column column-50">
                <form action="" method="POST">
                    ...
                    <input type="text" value="<?php echo $text ?? ''; ?>" name="search" class="float-right" style="width: 50%; margin-right:20px;" placeholder="Search">
                </form>
            </div>
        </div>
        <hr>
        <table class="words" >
            ...
            <tr>
                ...
                <td width="20%">
                    <a class="button" href="edit.php?id=<?php echo $word['id'] ?>">Edit</a> 
                    <a class="button button-outline" onclick="return confirm('Are you sure you want to delete this item?')"href="delete.php?id=<?php echo $word['id'] ?>">Delete</a>
                </td>
            </tr>
                <?php endforeach;?>
            </thead>
